...
if(!app.homeScreenVisible) {
    ...
    generateText("PeerIslands");

    // var imageLayer = myDocument.layers.add();
...
function generateImage() {
    var doc = app.activeDocument;
    var imageFile = new File("~/Documents/mohit.jpeg");
    var image = doc.pathItems.add();
    image.file = imageFile;
    image.position = [doc.width*.5-textFrame.width*.5, doc.height*.5+textFrame.width*.5];
}